...
ActiveRecord::Schema.define(version: 20180329062946) do
  ...
  create_table "employeers", force: :cascade do |t|
    ...
    t.string "username"
    t.text "about"
    t.index ["email"], name: "index_employeers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_employeers_on_reset_password_token", unique: true
  end
